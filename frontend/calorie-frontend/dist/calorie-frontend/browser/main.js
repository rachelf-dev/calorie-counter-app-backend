...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-BBMX72MM.js").then((m) => m.LoginComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-LYPW3YIV.js").then((m) => m.RegisterComponent)
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-4SABQGNR.js").then((m) => m.DashboardComponent)
  },
  {
    path: "history",
    loadComponent: () => import("./chunk-5LVABA6E.js").then((m) => m.HistoryComponent)
  },
  {
    path: "my-products",
    loadComponent: () => import("./chunk-5HZOHPPS.js").then((m) => m.MyProductsComponent)
  },
  {
    path: "my-products/new",
    loadComponent: () => import("./chunk-37B4FJSL.js").then((m) => m.ProductFormComponent)
  },
  {
  ...
  {
    path: "profile",
    loadComponent: () => import("./chunk-VYNG4F4X.js").then((m) => m.ProfileComponent)
  },
  {
    path: "admin",
    loadComponent: () => import("./chunk-NZ6Q4KD3.js").then((m) => m.AdminComponent)
  },
  { path: "", pathMatch: "full", redirectTo: "dashboard" },
  { path: "**", redirectTo: "dashboard" }
];

// src/app/store/logs/logs.actions.ts
var LogsActions = createActionGroup({
  source: "Logs",
  events: {
    "Load Today": emptyProps(),
    "Load Today Success": props(),
    "Load Today Failure": props(),
    "Add Item": props(),
    "Add Item Success": props(),
    "Add Item Failure": props(),
    "Remove Item": props(),
    "Remove Item Success": props(),
    "Remove Item Failure": props()
  }
});

// src/app/store/logs/logs.reducer.ts
var initialLogsState = {
  todayLog: null,
  loading: false,
  error: null
};
var logsFeature = createFeature({
  name: "logs",
  reducer: createReducer(initialLogsState, on(LogsActions.loadToday, LogsActions.addItem, LogsActions.removeItem, (state) => __spreadProps(__spreadValues({}, state), {
    loading: true,
    error: null
  })), on(LogsActions.loadTodaySuccess, LogsActions.addItemSuccess, LogsActions.removeItemSuccess, (state, { log }) => __spreadProps(__spreadValues({}, state), {
    todayLog: log,
    loading: false,
    error: null
  })), on(LogsActions.loadTodayFailure, LogsActions.addItemFailure, LogsActions.removeItemFailure, (state, { error }) => __spreadProps(__spreadValues({}, state), {
    loading: false,
    error
  })))
});
var { name: logsFeatureKey, reducer: logsReducer, selectLogsState, selectTodayLog, selectLoading, selectError } = logsFeature;
...
var LogService = class _LogService {
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LogService, factory: _LogService.\u0275fac, providedIn: "root" });
};
(() => {
...
// src/app/store/logs/logs.effects.ts
var LogsEffects = class _LogsEffects {
  actions$ = inject(Actions);
  logService = inject(LogService);
  loadToday$ = createEffect(() => this.actions$.pipe(ofType(LogsActions.loadToday), switchMap(() => this.logService.getToday().pipe(map((log) => LogsActions.loadTodaySuccess({ log })), catchError((error) => of(LogsActions.loadTodayFailure({
    error: error?.error?.message ?? "Failed to load today log"
  })))))));
  addItem$ = createEffect(() => this.actions$.pipe(ofType(LogsActions.addItem), switchMap(({ payload }) => this.logService.addToBasket(payload).pipe(map((log) => LogsActions.addItemSuccess({ log })), catchError((error) => of(LogsActions.addItemFailure({
    error: error?.error?.message ?? "Failed to add item"
  })))))));
  removeItem$ = createEffect(() => this.actions$.pipe(ofType(LogsActions.removeItem), switchMap(({ itemId }) => this.logService.removeFromBasket(itemId).pipe(map((log) => LogsActions.removeItemSuccess({ log })), catchError((error) => of(LogsActions.removeItemFailure({
    error: error?.error?.message ?? "Failed to remove item"
  })))))));
  static \u0275fac = function LogsEffects_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LogsEffects)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LogsEffects, factory: _LogsEffects.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LogsEffects, [{
    type: Injectable
  }], null, null);
})();
...
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], hostAttrs: ["dir", "rtl", "lang", "he"], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet], host: {
      dir: "rtl",
      lang: "he"
    }, template: `<router-outlet />`, styles: ["/* angular:styles/component:scss;b12e85be7d455115f6d554170e92b6088ef37ef9bf708b0eae91cd65079b1ecd;C:/Users/User/Desktop/calorie-counter-app/frontend/calorie-frontend/src/app/app.ts */\n:host {\n  display: block;\n  min-height: 100vh;\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {
